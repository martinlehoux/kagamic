...
int test_json_integer() {
    ...
    t_assert_equal(Arena_get_used(perm), 44);
    return 0;
}
...
int test_json_int_array() {
    ...
    t_assert(ints[2] == 3);
    t_assert(sum == 6);
    t_assert_equal(Arena_get_used(perm), 464);
...
int test_json_empty_array() {
    ...
    t_assert_equal(Arena_get_used(perm), 160);
...
int test_json_nested_array() {
    ...
    t_assert_equal(Arena_get_used(perm), 427);
...
int test_json_string() {
    ...
    t_assert_equal(Arena_get_used(perm), 59);
...
int test_json_empty_object() {
    ...
    t_assert_equal(Arena_get_used(perm), 320);
...
int test_json_object() {
    ...
    t_assert_equal(Arena_get_used(perm), 405);
...
int test_json_boolean() {
    ...
    t_assert_equal(Arena_get_used(perm), 460);
